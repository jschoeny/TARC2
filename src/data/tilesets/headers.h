...
const struct Tileset gTileset_OldenTimes =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_OldenTimes,
    .palettes = gTilesetPalettes_OldenTimes,
    .metatiles = gMetatiles_OldenTimes,
    .metatileAttributes = gMetatileAttributes_OldenTimes,
    .callback = NULL,
};
...
const struct Tileset gTileset_OldenTimesTown =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_OldenTimesTown,
    .palettes = gTilesetPalettes_OldenTimesTown,
    .metatiles = gMetatiles_OldenTimesTown,
