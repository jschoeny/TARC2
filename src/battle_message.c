...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_CANTESCAPE]                           = COMPOUND_STRING("There's no running from this battle!\p"),
    ...
    [STRINGID_TARGETTOUGHEDITOUT]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} held on because it wants to protect you!"),
