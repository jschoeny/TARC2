...
enum StringID
{
    ...
    STRINGID_SHADOWPKMNNOTICE,
    STRINGID_SHADOWPKMNFIRSTENCOUNTER,
    STRINGID_STARTEDSHADOW_SKY,
    STRINGID_SHADOW_SKYCONTINUES,
    STRINGID_SHADOW_SKYSTOPPED,
    STRINGID_SHADOW_SKYDAMAGE,
    STRINGID_PLAYERFOUNDITEM,
    STRINGID_PLACEDITEMINBAG,
    STRINGID_PLACEDITEMSINBAG,
    STRINGID_COUNT
};
