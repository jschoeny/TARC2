...
void CreateScriptedWildShadowMon(u16 species, u8 level, u16 item)
{
    ...
    ZeroEnemyPartyMons();
    CreateMonShadow(&gEnemyParty[0], species, level, USE_RANDOM_IVS, 0, 0, OT_ID_PLAYER_ID, 0, TRUE);
    if (item)
    {
        heldItem[0] = item;
        heldItem[1] = item >> 8;
...
void CreateScriptedDoubleWildShadowMon(u16 species1, u8 level1, u16 item1, bool8 isShadow1, u16 species2, u8 level2, u16 item2, bool8 isShadow2)
{
    u8 heldItem1[2];
    u8 heldItem2[2];
    ...
    CreateMonShadow(&gEnemyParty[0], species1, level1, 32, 0, 0, OT_ID_PLAYER_ID, 0, isShadow1);
    if (item1)
    {
        heldItem1[0] = item1;
        heldItem1[1] = item1 >> 8;
    ...
    CreateMonShadow(&gEnemyParty[3], species2, level2, 32, 0, 0, OT_ID_PLAYER_ID, 0, isShadow2);
    if (item2)
    {
        heldItem2[0] = item2;
        heldItem2[1] = item2 >> 8;
