...
{
    { COMPOUND_STRING("Story Progress"), DebugAction_ExecuteScript, Debug_EventScript_Script_1 },
    { COMPOUND_STRING("Defeat Wooper"), DebugAction_ExecuteScript, Debug_EventScript_Script_2 },
    { COMPOUND_STRING("Credits"), DebugAction_ExecuteScript, Debug_EventScript_Script_3 },
    ...
    { COMPOUND_STRING("Overworld Evo"), DebugAction_ExecuteScript, Debug_EventScript_Script_8 },
    { NULL }
};
...
#define SOUND_LIST_BGM              \
    ...
    X(PH_NURSE_HELD) \
    X(PH_NURSE_SOLO) \
    X(MUS_PMDRED_RESCUE_TEAM_BASE) \
    X(MUS_PMDRED_FRIEND_AREA_SWAMP) \
    X(MUS_PMDRED_FRIEND_AREA_CAVES) \
    X(MUS_PMDRED_DREAM) \
    X(MUS_PMDRED_BENEVOLENT_SPIRIT) \
    X(MUS_PMDRED_LEGEND_OF_NINETALES) \
    X(MUS_PMDRED_POKEMON_SQUARE) \
    X(MUS_PMDRED_FILE_SELECT) \
    X(MUS_PMDRED_RISING_FEAR) \
    X(MUS_PMDRED_THERES_TROUBLE) \
    X(MUS_PMDRED_BOSS_BATTLE) \
    X(MUS_PMDRED_WELCOME_TO_THE_WORLD_OF_POKEMON) \
    X(MUS_PMDRED_A_NEW_ADVENTURE) \
    X(MUS_PMDRED_THUNDERWAVE_CAVE) \
    X(MUS_PMDRED_SINISTER_WOODS) \
    X(MUS_PMDRED_FRIEND_AREA_POND) \
    X(MUS_PMDRED_KECLEON_SHOP) \
    X(MUS_PMDRED_STOP_THIEF) \
    X(MUS_PMDRED_WORLD_CALAMITY) \
    X(MUS_PMDRED_GREAT_CANYON) \
    X(MUS_PMDRED_STORMY_SEA) \
    X(MUS_PMDRED_SKY_TOWER) \
    X(MUS_PMDRED_SKY_TOWER_SUMMIT) \
    X(MUS_PMDRED_THE_ESCAPE) \
    X(MUS_PMDRED_MT_BLAZE) \
    X(MUS_PMDRED_RAYQUAZAS_DOMAIN) \
    X(MUS_PMDRED_FRIEND_AREA_STRATOS_LOOKOUT) \
    X(MUS_PMDRED_FRIEND_AREA_RAINBOW_PEAK) \
    X(MUS_PMDRED_DREAM_EATER) \
    X(MUS_PMDRED_FRIEND_AREA_DEEPSEA_CURRENT) \
    X(MUS_PMDRED_FRIEND_AREA_SEAFLOOR_CAVE) \
    X(MUS_PMDRED_BATTLE_WITH_RAYQUAZA) \
    X(MUS_PMDRED_MT_BLAZE_PEAK) \
    X(MUS_PMDRED_FRIEND_AREA_VOLCANIC_PIT) \
    X(MUS_PMDRED_FRIEND_AREA_CRYPTIC_CAVE) \
    X(MUS_PMDRED_ESCAPE_THROUGH_THE_SNOW) \
    X(MUS_PMDRED_THE_OTHER_SIDE) \
    X(MUS_PMDRED_THE_MOUNTAIN_OF_FIRE) \
    X(MUS_PMDRED_FROSTY_GROTTO) \
    X(MUS_PMDRED_INTRO) \
    X(MUS_PMDRED_AFTERMATH) \
    X(MUS_PMDRED_FAREWELL) \
    X(MUS_PMDRED_TITLE_SCREEN) \
    X(MUS_PMDRED_CREDITS) \
    X(MUS_PMDRED_TIME_OF_REUNION) \
    X(MUS_PMDRED_OPENING_TITLE) \
    X(MUS_PMDRED_DUMMY) \
    X(MUS_PMDRED_DUNGEON_FAIL) \
    X(MUS_PMDRED_DUNGEON_COMPLETE) \
    X(MUS_PMDRED_FRIEND_AREA_UNUSED_1) \
    X(MUS_PMDRED_HEARTWARMING) \
    X(MUS_PMDRED_LAPIS_CAVE) \
    X(MUS_PMDRED_A_SUCCESSFUL_RESCUE) \
    X(MUS_PMDRED_FROSTY_FOREST) \
    X(MUS_PMDRED_FRIEND_AREA_STEPPE) \
    X(MUS_PMDRED_FRIEND_AREA_OCEANIC) \
    X(MUS_PMDRED_FRIEND_AREA_FIELD) \
    X(MUS_PMDRED_MAGMA_CAVERN) \
    X(MUS_PMDRED_FRIEND_AREA_UNUSED_2) \
    X(MUS_PMDRED_MAKUHITA_DOJO) \
    X(MUS_PMDRED_MT_THUNDER) \
    X(MUS_PMDRED_FRIEND_AREA_LAB) \
    X(MUS_PMDRED_SILENT_CHASM) \
    X(MUS_PMDRED_IN_THE_DEPTHS_OF_THE_PIT) \
    X(MUS_PMDRED_MT_FREEZE) \
    X(MUS_PMDRED_FRIEND_AREA_WILDS) \
    X(MUS_PMDRED_FRIEND_AREA_LEGENDARY_ISLAND) \
    X(MUS_PMDRED_FRIEND_AREA_SOUTHERN_ISLAND) \
    X(MUS_PMDRED_FRIEND_AREA_ENCLOSED_ISLAND) \
    X(MUS_PMDRED_MT_STEEL) \
    X(MUS_PMDRED_FRIEND_AREA_FOREST) \
    X(MUS_PMDRED_FRIEND_AREA_FINAL_ISLAND) \
    X(MUS_PMDRED_MT_FREEZE_PEAK) \
    X(MUS_PMDRED_MAGMA_CAVERN_PIT) \
    X(MUS_PMDRED_TINY_WOODS) \
    X(MUS_PMDRED_MT_THUNDER_PEAK) \
    X(MUS_PMDRED_FRIEND_AREA_HEALING_FOREST) \
    X(MUS_PMDRED_MONSTER_HOUSE) \
    X(MUS_HG_NEW_BARK) \
    X(MUS_CIPHER_ADMIN_BATTLE) \
    X(MUS_PMD_SKY_VS_DIALGA) \
