...
static const u8 sHappyMsg00[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} began poking you in the\nstomach.");
static const u8 sHappyMsg01[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} is happy but shy.");
static const u8 sHappyMsg02[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} is coming along happily.");
static const u8 sHappyMsg03[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_NORMAL}{STR_VAR_1} is composed.");
static const u8 sHappyMsg04[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} seems to be feeling\ngreat about walking with you!");
static const u8 sHappyMsg05[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_JOYOUS}{STR_VAR_1} is glowing with health.");
static const u8 sHappyMsg06[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_JOYOUS}{STR_VAR_1} looks very happy.");
static const u8 sHappyMsg07[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_INSPIRED}{STR_VAR_1} put in extra effort.");
static const u8 sHappyMsg08[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_INSPIRED}{STR_VAR_1} is smelling the scents\nof the surrounding air.");
static const u8 sHappyMsg09[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_JOYOUS}{STR_VAR_1} is jumping for joy!");
static const u8 sHappyMsg10[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} is still feeling great!");
static const u8 sHappyMsg11[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_NORMAL}Your POKéMON has caught the scent of\nsmoke.");
static const u8 sHappyMsg12[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} is poking at your belly.");
static const u8 sHappyMsg13[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_NORMAL}Your POKéMON stretched out its body\nand is relaxing.");
static const u8 sHappyMsg14[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} looks like it wants to\nlead!");
static const u8 sHappyMsg15[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} is doing its best to\nkeep up with you.");
static const u8 sHappyMsg16[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} is happily cuddling up\nto you!");
static const u8 sHappyMsg17[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_JOYOUS}{STR_VAR_1} is full of life!");
static const u8 sHappyMsg18[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} seems to be very happy!");
static const u8 sHappyMsg19[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_JOYOUS}{STR_VAR_1} is so happy that it\ncan't stand still!");
static const u8 sHappyMsg20[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_NORMAL}{STR_VAR_1} nodded slowly.");
static const u8 sHappyMsg21[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} is very eager!");
static const u8 sHappyMsg22[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_NORMAL}{STR_VAR_1} is wandering around and\nlistening to the different sounds.");
static const u8 sHappyMsg23[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_NORMAL}{STR_VAR_1} looks very interested.");
static const u8 sHappyMsg24[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_NORMAL}{STR_VAR_1} is somehow forcing\nitself to keep going.");
static const u8 sHappyMsg25[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_JOYOUS}{STR_VAR_1} gave you a sunny look!");
static const u8 sHappyMsg26[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} gives you a happy look\nand a smile.");
static const u8 sHappyMsg27[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_NORMAL}Your POKéMON is smelling the scent\nof flowers.");
static const u8 sHappyMsg28[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_INSPIRED}{STR_VAR_1} seems very happy to see\nyou!");
static const u8 sHappyMsg29[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} faced this way and\ngrinned.");
static const u8 sHappyMsg30[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} happily cuddled up to\nyou!");
// Conditional messages begin here, index 31
static const u8 sHappyMsg31[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}Your POKéMON seems happy about the\ngreat weather.");
static const u8 sHappyMsg32[] = _("{CREATE_MUGSHOT MUGSHOT_GROWLITHE EMOTE_HAPPY}{STR_VAR_1} is very composed and\nsure of itself!");
