...
#define B_SMART_WILD_AI_FLAG        FLAG_SMART_WILD_AI_FLAG     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
...
#define B_FLAG_NO_RUNNING           FLAG_NO_RUNNING_FROM_BATTLE     // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
...
#define B_FLAG_NO_WHITEOUT          FLAG_NO_WHITEOUT_FROM_BATTLE     // If this flag is set, the player can not white out against Trainers. Please note that the party is not healed automatically!
