...
const u8 gTrainerBackPic_Player[] = INCBIN_U8("graphics/trainers/back_pics/player.4bpp");
const u16 gTrainerBackPicPalette_Player[] = INCBIN_U16("graphics/trainers/back_pics/player.gbapal");
...
static const union AnimCmd *const sBackAnims_SingleFrame[] =
{
    sAnim_GeneralFrame0,
    sAnim_GeneralFrame0,
    sAnim_GeneralFrame0,
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_PLAYER, 4, gTrainerBackPic_Player, gTrainerBackPicPalette_Player, sBackAnims_SingleFrame),
};
