...
$(OBJEVENTGFXDIR)/people/hgss_little_boy.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/hgss_old_lady.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/misc/fire.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/misc/fire_l.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/misc/fire_r.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/misc/fire_lr.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/misc/blight.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 8 -mheight 8

$(OBJEVENTGFXDIR)/misc/arcanine_statue.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/misc/item_sparkle.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
