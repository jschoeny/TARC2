...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .shadowLearnset = sHoothootShadowLearnset,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_SKIPLOOM] =
    {
        ...
        .shadowLearnset = sSkiploomShadowLearnset,
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .shadowLearnset = sWooperShadowLearnset,
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .shadowLearnset = sMurkrowShadowLearnset,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .shadowLearnset = sLarvitarShadowLearnset,
