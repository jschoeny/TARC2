...
const u16 gMetatiles_OldenTimes[] = INCBIN_U16("data/tilesets/primary/olden_times/metatiles.bin");
const u16 gMetatileAttributes_OldenTimes[] = INCBIN_U16("data/tilesets/primary/olden_times/metatile_attributes.bin");
