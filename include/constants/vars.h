...
#define VAR_WILD_SHADOW_CHANCE                           0x404E
...
#define VAR_MSG_TRACKER               0x8014 // Increases by 1 when {CLOSE} is used. Must be reset manually.
