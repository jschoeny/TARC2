...
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_HGSS_LittleBoy;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_HGSS_OldLady;
